...
def train(environment: Union[envs_v1.Env, envs.Env],
  ...
  artifact = wandb.Artifact("ant-test",type="datatest")
  ...
  for it in range(num_evals_after_init):
    ...
    wandb.log({"epoch": it})
    wandb.log({"reward": metrics['eval/episode_reward'], "total_loss": metrics['training/total_loss'], "v_loss": metrics['training/v_loss']})
